    ...
    return {
        ...
        execute: function() {
            ArticleComponent = (function () {
                function ArticleComponent(_routeParams, _articleService) {
                ...
                ArticleComponent.prototype.ngOnInit = function () {
                    ...
                    this._articleService.getArticle(id).then(function (article) { return _this.article = article; });
                };
                ArticleComponent = __decorate([
                    core_1.Component({
                        template: "\n    <h1 *ngIf=\"article\">{{article.title}}</h1>\n    <div *ngIf=\"article\" [innerHtml]=\"article.content\"></div>\n  ",
                    }), 
                    __metadata('design:paramtypes', [router_1.RouteParams, article_service_1.ArticleService])
                ], ArticleComponent);
